...
class RegistUser(Resource):
    ...
    def post(self):
        ...
        if state is not None and pdata == None:
            ...
            # print("\n[DEBUG1-3]flask result (locations) >>", locations[0], locations[1], end="\n\n\n")
            # print("\n[DEBUG1-3]flask result (info url) >>", locations[2], end="\n\n\n")
...
class ImageAnalysis(Resource):
    ...
    def post(self):
        ...
        for file_id in img_file:
            ...
            # result = [['message', message], ['sender', 'chatbot'], ['receiver', 'User'], ['imageurl', imgurl]]
